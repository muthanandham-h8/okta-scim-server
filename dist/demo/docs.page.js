...
exports.METHOD_SLUGS = void 0;
exports.renderDocsIndex = renderDocsIndex;
exports.renderMethodPage = renderMethodPage;
...
`;
const shell = (title, body, buildId) => `<!doctype html>
...
exports.METHOD_SLUGS = ['saml', 'swa', 'oin', 'private'];
function renderMethodPage(method, cfg) {
