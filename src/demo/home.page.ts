// Minimalist live dashboard served at /home. Two things only: the provisioned
// user table and a clear activity log (request → response, from→to, headers +
// payload). Plus a small stats card and a clear-database action. The old "How it
// works" explainer moved to /docs.

export interface HomeConfig {
  buildId: string;
}

export function renderHomePage(cfg: HomeConfig): string {
